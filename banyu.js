        ...
        if (btnSudahBaca.checked == false) {
            if (data.length > 0) {
                ...
                dataTable1.push({
                    ...
                    'year': document.getElementById("tahun").valueAsNumber,
                    'isComplete': false
                });
                var checkData = localStorage.getItem("databuku1");
            ...
            var tahun = row.insertCell(2);
            tahun.innerHTML = document.getElementById("tahun").valueAsNumber;
...
function searchData1() {
    ...
    var dataFilterBuku = dataTable1.filter(object => {
        return object.title.includes(searchValue) || object.author.includes(searchValue);
    })
...
function searchData2() {
    ...
    var dataFilterBuku2 = dataTable2.filter(object => {
        return object.title.includes(searchValue2) || object.author.includes(searchValue2);
    })
